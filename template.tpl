...
- name: test with event properties
  code: |-
    ...
    assertThat(capturedCall.action).isEqualTo('custom-event');
    assertThat(capturedCall.params.kind).isEqualTo('conversion');
    assertThat(capturedCall.params.data).isEqualTo('user signup');
